...
The override of existing services is forbidden by default. You can allow the override by explicitly setting the parameter `plugin_allow_overrides` equal to `true` in the `app/config/local.php` file.
